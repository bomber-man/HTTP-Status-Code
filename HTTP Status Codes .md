...
#### This file consists of all the HTTP Status Codes which a Developer and QA should know.
...
## ** Below is the list for all the status Code.
...
## ** 3xx Redirectiobal Status Codes
